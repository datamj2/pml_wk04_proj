...
###Variable importance
Table 1 lists the ten most important variables (predictors) and ten least important variables (apparently based on Gini).
```{r echo=T,eval=F}
vi<-varImp(mr2)
```
...
###Class centers
Figure 2 plots the class centers for plots of the two most important variables and two least important variables from Table 1. Although there is no clear clustering in either of the top panels, the class centers are better separated for the two most important variables compared to the two least important variables.
```{r fig.cap=fig2_cap}
