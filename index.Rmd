...
####Variable importance
Variable (predictor) importance in descending order of importance appears in Table 1.
```{r echo=T,eval=F}
vi<-varImp(mr2)
```
...
library(knitr)
tab_cap<-"Table 1. List of top 10 predictors in descending order of importance"
